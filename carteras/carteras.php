...
<body>
    ...
    <div id="page-content-wrapper">
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom"> 
       ...
       <div class="container-fluid"  >
        ...
        <h3 class="mt-2">Lista Carteras</h3>
        <hr>
          ...
          <div class="card mt-2">
              <div class="card-header bg-primary" id="headingOne">
                <a  class="btn btn-success float-right text-light" data-toggle="modal" data-target="#modalCarteras"><i class="fa fa-plus"></i> Nueva Cartera</a>
                  ...
                  <table class="table table-sm table-hover table-bordered">
                    ...
                    <tbody> 
                      <tr>
                        ...
                        <td scope="col" class="text-left">CARTERA CULIACAN A</td>
                        <td scope="col" class="text-center">MIGUEL ANGEL PARRA RUIZ</td>
  ...
  <!-- /#modals -->
  <?php   include('../modals/modalCarteras.php'); ?>
  <!-- /#modals -->
